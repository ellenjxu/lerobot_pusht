...
from lerobot_kinematics.typess import ArrayLike, NDArray
...
class ET(BaseET):
    ...
    def __mul__(self, other: "ET") -> "ETS":
        return ETS([self, other])

    def __add__(self, other: "ET") -> "ETS":
...
class ET2(BaseET):
    ...
    def __mul__(self, other: "ET2") -> "ETS2":
        return ETS2([self, other])

    def __add__(self, other: "ET2") -> "ETS2":
        return self.__mul__(other)
